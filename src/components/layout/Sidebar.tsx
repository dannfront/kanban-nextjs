    ...
    <>
      ...
      >
        <div className="flex h-full flex-col   pt-8">
          ...
          <button
            ...
            className="hidden mx-auto cursor-pointer items-center gap-4 px-4 text-[0.9375rem] font-bold text-[var(--color-medium-gray)] transition-colors hover:text-[var(--color-red)] md:flex"
          >
            <Image src={iconHideSidebar.src} alt="" width={18} height={16} />
            Hide Sidebar
          </button>
      ...
      {desktopHidden && (
        <button
          type="button"
          onClick={toggleDesktop}
          className="fixed cursor-pointer bottom-8 left-0 z-40 hidden h-12 w-14 items-center justify-center rounded-r-full bg-[var(--color-main-purple)] text-white transition-colors hover:bg-[var(--color-main-purple-hover)] md:flex"
